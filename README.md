...
### Methods: Curiosity
 ...
 - **Methods for working with people and institutions.**  A core principle of L<sup>3</sup> is that everyone is an expert in something. This includes lab members as well as archivists, museum professionals, educators, survivors, descendants, students, technologists, and community partners. We do not treat people merely as sources of extractable data. When research involves human participants or institutional partners, we approach it as a relationship shaped by consent, reciprocity, expertise, and continuing responsibility.
 
 - **Methods for identifying and gathering "data"**.  Data is made, not born, and there is no such thing as raw data. Search queries, prompts, screenshots, model outputs, archival records, metadata, annotations, benchmarks, and evaluation categories all emerge through situated decisions. Every dataset should therefore be accompanied by documentation explaining how it was produced, selected, cleaned, transformed, labeled, and interpreted. We do not assume that publicly accessible information is ethically unrestricted information. Data creation establishes relationships with people, institutions, platforms, historical subjects, and communities, and those relationships create responsibilities. Model outputs are also research objects rather than transparent answers. Record the model, version or access date, system settings when available, prompt structure, sampling procedure, and any transformations made before analysis.
  
- **Methods for creating and communicating**.  L<sup>3</sup> encourages work in multiple forms, including scholarly articles, datasets, code, model-evaluation frameworks, visualizations, exhibitions, websites, teaching materials, public essays, workshops, and experimental interfaces. The format should follow the audience and purpose. Before producing an output, ask whether the goal is to report findings, reveal the limitations of a system, support a cultural institution, create a reusable research method, or prompt audiences to reconsider how AI mediates knowledge.

## How the Lab works

**We are an experiment in collaborative and interdisciplinary research.**  Our projects bring together humanistic interpretation, technical experimentation, historical research, and institutional partnership. No single disciplinary method or form of expertise is sufficient for the questions we study. This means several things:

  - **Projects are more than the sum of their parts**. We share materials, data, methods, documentation, and emerging findings across the lab whenever ethical, legal, and institutional restrictions permit. Individual members may lead particular components, but access to shared work does not erase authorship, labor, or responsibility.
  
  - **We do exploratory research.**  We do not always know where an inquiry will lead at the outset. Sometimes this means following a path for a considerable period before recognizing that it is not productive. Trust your intuitions, because they are what we rely on to find interesting things. Check in frequently and talk about what you are trying to do. Exploration does not mean proceeding without documentation: record unsuccessful approaches, prompt changes, coding decisions, methodological concerns, and reasons for abandoning a line of inquiry.
  
  - **A pedagogical experiment.** For *grad students*, the lab offers opportunities to conduct interdisciplinary research beyond the boundaries of an individual dissertation, develop unfamiliar methods, and participate in collaborative publication. The lab makes no automatic claim on members’ independent research or dissertation work. For *undergrads* the goal should be to experience starting and finishing research, and to learn a set of skills that can be used in both research and non-research settings. 

 -  **Clear responsibility, broad participation.**  The lab is collaborative, but it is not structureless. Faculty, graduate researchers, and project leads hold different forms of responsibility, particularly for funding, ethics, deadlines, institutional partnerships, and publication. Within those structures, all members should be able to propose ideas, question methods, raise concerns, and shape the work.

 - **Everyone should produce something**.  Most scholarly work (publications and books) takes a LONG time to produce, longer than most undergraduates are involved, and even some grad students.  Therefore, the goal is to try to make whatever can be finished in the time you have to participate, and then other people can build on that (including the PI or postdocs who take responsibility for getting things to publication). This might include a documented dataset, annotation guide, literature review, prompt set, evaluation protocol, code repository, visualization, archival finding aid, public essay, teaching resource, or short working paper. Focus on the intermediate steps, and take joy when it all comes together eventually. 
...
12. *Document computational decisions.* Record prompts, models, dates, parameters, preprocessing decisions, code versions, annotation criteria, and known limitations. Documentation should allow another researcher to understand how an output was produced and, where technically possible, reproduce the procedure.

13. *Treat model outputs as claims, not sources of authority.* Verify factual claims against appropriate primary and secondary sources. Do not cite an AI-generated response as evidence for the historical claim it makes. When the model output itself is the object of analysis, preserve enough contextual information to interpret it responsibly. When model-generated citations are present, verify both the existence of the cited source and whether it supports the associated claim.

14. *Do not anthropomorphize models unnecessarily.* Prefer precise descriptions of system behavior over claims about what a model “knows,” “believes,” “understands,” “remembers,” or “intends,” unless those terms are being quoted, critically examined, or explicitly defined as analytical shorthand.

15. *Report harmful or sensitive outputs responsibly.* Historical fabrication, denial, racism, antisemitism, graphic violence, and other harmful outputs may be necessary objects of analysis. Reproduce them only to the extent required for evidence, provide context, and consider whether publication may amplify the harm being studied. When appropriate, consult relevant partners or domain experts and provide content warnings or restricted access rather than reproducing harmful material without mediation.

16. *Child Care*. Some people have care responsibilities for a child or children in their life, whether as a parent, an older sibling, cousin, etc. If your childcare needs ever come into conflict with the lab schedule, please don't feel as though you need to miss a lab meeting. We understand that sometimes plans fall though. If this happens, you are welcome to bring a child to lab meetings or lab work with you. We simply ask that you bring materials to keep them busy, and remain mindful of your labmates. 

17. *Animals*.  Animals are welcome in the lab, and appreciated, but please check in with the other members first if you can, not everyone has the same levels of comfort.  The campus also has rules about animals, which you should be mindful of. Service animals are accommodated in accordance with university policy and do not require group approval.
